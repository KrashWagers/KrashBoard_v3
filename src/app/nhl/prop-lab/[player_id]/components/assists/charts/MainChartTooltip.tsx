    ...
    <div className="bg-[#1a1a1a] border-2 border-gray-700 rounded-lg p-4 shadow-2xl">
      ...
      <div className="space-y-2">
        <div className="flex justify-between items-center gap-6">
          ...
          <span className="text-white font-bold text-lg">{data.assists ?? 0}</span>
        </div>
        <div className="flex justify-between items-center gap-6">
        ...
        <div className="flex justify-between items-center gap-6">
          ...
          <span className="text-blue-400 text-sm">{data.pp_assists ?? 0}</span>
        </div>
        <div className="flex justify-between items-center gap-6">
          <span className="text-gray-400 text-xs">5v5 Assists</span>
          <span className="text-blue-400 text-sm">{data["5v5_assists"] ?? 0}</span>
        </div>
      </div>
    </div>
  )

    ...
    <div className="bg-[#1a1a1a] border-2 border-gray-700 rounded-lg p-4 shadow-2xl">
      ...
      <div className="space-y-2">
        <div className="flex justify-between items-center gap-6">
          ...
          <span className="text-white font-bold text-lg">{data.shots_on_goal ?? 0}</span>
        </div>
        <div className="flex justify-between items-center gap-6">
          <span className="text-gray-400 text-xs">Shot Attempts</span>
          <span className="text-gray-300 text-sm">{data.corsi ?? 0}</span>
        </div>
        <div className="flex justify-between items-center gap-6">
        ...
        <div className="flex justify-between items-center gap-6">
          ...
          <span className="text-blue-400 text-sm">{data.pp_shots_on_goal ?? 0}</span>
        </div>
        <div className="flex justify-between items-center gap-6">
          <span className="text-gray-400 text-xs">5v5 SOG</span>
          <span className="text-blue-400 text-sm">{data["5v5_shots_on_goal"] ?? 0}</span>
        </div>
      </div>
    </div>
  )
